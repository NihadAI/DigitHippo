...
var yourOwnAndPurchased = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var user, products, ownProductFileIds, orders, purchasedProductFieldIds;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    orders = (_b.sent()).docs;
                    purchasedProductFieldIds = orders.map(function (order) {
                        return order.products.map(function (product) {
                            if (typeof product === "string") {
                                return req.payload.logger.error('Search depth is insufficient to find purchased file IDs');
                            }
                    ...
                    return [2 /*return*/, {
                            id: {
                                in: __spreadArray(__spreadArray([], ownProductFileIds, true), purchasedProductFieldIds, true)
                            }
                        }];
            }
        });
